...
{
    string libros[1][39];
    cout << "Programacion en Visual Basic: \n";
    string titulo ,autor;
    for(int i = 0; i < 5; i++)
    {
        cout << "\n******* Libro " << i + 1 << "********:\n";
...
void  cargarLibros () {
	...
	libros [ 3 ] [ 0 ] = " Algoritmos " ; libros [ 3 ] [ 1 ] = " Fundamentos de Informática y Programación " ;
	...
	libros [ 13 ] [ 0 ] = " Metodologias de desarrollo de software " ; libros [ 13 ] [ 1 ] = " Compendio de Ingeniería del Software " ;
	...
	libros [ 27 ] [ 0 ] = " PHP " ; libros [ 27 ] [ 1 ] = " Symfony 1.4, la guía definitiva " ;
